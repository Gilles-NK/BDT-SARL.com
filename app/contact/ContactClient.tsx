      ...
      <section style={{ padding: "4rem 2rem 6rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "3rem" }}>
            ...
            <p style={{ color: "#4b5563", fontSize: "1rem", lineHeight: 1.6, maxWidth: 850 }}>
              {c.description}
            </p>
          </div>
            ...
            <div style={{ background: "#fff", borderRadius: 0, padding: 0, boxShadow: "none" }}>
              {etat === "envoye" ? (
                <div style={{ textAlign: "center", padding: "3rem 1rem" }}>
                  ...
                  <h3 style={{ fontFamily: "Ubuntu, sans-serif", color: "#1a1a2e", marginBottom: "0.5rem" }}>
                    {c.envoye}
                  </h3>
                  ...
                  <button
                    ...
                    style={{ background: "#f2f2f2", color: "#1a1a2e", border: "none", padding: "0.75rem 1.75rem", borderRadius: 0, fontWeight: 700, cursor: "pointer" }}
                  >
                    {c.nouveau}
                  </button>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }} className="form-2col">
                    <input
                      ...
                      placeholder={c.prenomPlaceholder}
                      style={inp("prenom")}
                  ...
                  <input
                    ...
                    placeholder={c.entreprisePlaceholder}
                  ...
                  <label style={{ display: "flex", alignItems: "center", gap: "0.8rem", color: "#4b5563", fontSize: "0.9rem", cursor: "pointer", marginTop: "0.5rem", marginBottom: "0.5rem" }}>
                    <input
